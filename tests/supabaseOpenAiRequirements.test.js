...
test('OpenAI Responses 요청은 비저장 strict schema와 내장 web search 출처를 사용한다', () => {
  ...
  assert.match(source, /GEMINI_KEY/)
  assert.match(source, /GEMINI_API_KEY/)
  assert.match(source, /GEMINI_MODEL/)
  assert.match(source, /isQuotaExhausted\(response, responseBody\)/)
  ...
  assert.match(source, /groundingMetadata/)
  assert.match(source, /providerErrorCode\(body\)/)
